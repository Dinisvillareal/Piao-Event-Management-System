...
export default function MemberDashboard() {
  ...
  const [userMembershipsCount, setUserMembershipsCount] = useState(0); // ✅ ADDED
  ...
  // ✅ ADD THIS EFFECT - Fetch user's actual memberships count
  useEffect(() => {
    if (!member.id) return;
            ...
            <div className="space-y-5 p-5">
              {active === "dashboard" && (
                <DashboardView
                  ...
                  membershipsCount={userMembershipsCount}  // ✅ CHANGED: using userMembershipsCount
                  attendedCount={attended}
                  missedCount={missed}
                  setActive={setActive}
                  notifications={notifications}
