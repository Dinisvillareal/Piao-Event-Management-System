...
export default function SummaryCard({ value, title, gradient, onClick }: SummaryCardProps) {
  return (
    <button
      onClick={onClick}
      className={`w-full rounded-[30px] bg-gradient-to-r ${gradient} p-5 text-left text-white transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_18px_45px_rgba(0,0,0,0.22)]`}
    >
